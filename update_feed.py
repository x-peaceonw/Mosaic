...
ARTISTS = ["Olivia Dean","SZA", "Beyonce","Jhene Aiko", "Olivia Dean", "Coldplay", "Qendresa", "Solange", "Tori Kelly", "Rascal Flatts", "Sondae","Ariana Grande"]
TICKET_ARTISTS = ["Beyonce", "Coldplay","Jhene Aiko", "Tori Kelly","Olivia Dean"]
NEWS_TOPICS = [
